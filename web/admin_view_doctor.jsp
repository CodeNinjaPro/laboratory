...
//            } else if (session.getAttribute("usertype") == "Supervisor") {
...
//            }
    ...
    <body onload="load()">
            ...
            <div class="page-content d-flex align-items-stretch">
                ...
                <nav class="side-navbar">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="admin_view_appointment.jsp"><i class="fa fa-file-text-o"></i>Appointment</a></li>
                        <li><a href="admin_view_patient.jsp"><i class="fa fa-users"></i>Patient</a></li>
                        <li><a href="admin_view_payment.jsp"><i class="fa fa-money"></i>Payment</a></li>
                        <li><a href="admin_view_report.jsp"><i class="fa fa-bar-chart-o"></i>Report</a></li>
                        <li class="active"><a href="admin_view_doctor.jsp"><i class="fa fa-user-md"></i>Doctor</a></li></br>
                        <li><a href="logout.jsp"><i class="fa fa-sign-out"></i>Logout</a></li>
                    </ul>
                    <span class="heading">Admin</span>
                    <ul class="list-unstyled">
                        <li><a href="admin_view_user.jsp"><i class="fa fa-cab"></i>User Management</a></li>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header d-flex align-items-center">
                                            <h3 class="h4">Doctor</h3>
                                        </div>
                                        <div class="card-body">
                                            <form class="form-horizontal" id="form">
                                                <div class="form-group row">
                                                    <div class="col-sm-9">
                                                        <input id="doctor_id" type="hidden"	value="0" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-sm-3 form-control-label">Specialization</label>
                                                    <div class="col-sm-9">
                                                        <input id="specialization" type="text"	placeholder="specialization" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-3 form-control-label">Available Days</label>
                                                    <div class="col-sm-9">
                                                        <input id="available_days" type="text"	placeholder="available days" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-3 form-control-label">Available Time</label>
                                                    <div class="col-sm-9">
                                                        <input id="available_time" type="text"	placeholder="available time" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input id="contact" onkeypress="contactValidation()" type="text"	placeholder="contact" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-9">
        ...
        <script src="Ajax/DoctorJS.js" type="text/javascript"></script>
