...
//            }
    ...
    <body onload="load()">
            ...
            <div class="page-content d-flex align-items-stretch">
                ...
                <nav class="side-navbar">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="active"><a href="admin_view_patient.jsp"><i class="fa fa-users"></i>Patient</a></li>
                        ...
                        <li><a href="admin_view_doctor.jsp"><i class="fa fa-user-md"></i>Doctor</a></li></br>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header d-flex align-items-center">
                                            <h3 class="h4">Patient</h3>
                                        </div>
                                        <div class="card-body">
                                            <form class="form-horizontal">
                                                <div class="form-group row">
                                                    <div class="col-sm-9">
                                                        <input id="patient_id" type="hidden"	value="0" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input id="dob" type="date"	placeholder="dob" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input id="username" type="text"	value="user" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-3 form-control-label">Password</label>
                                                    <div class="col-sm-9">
                                                        <input id="password" type="text"	value="user" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-9">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-9 offset-sm-3">
                                                        ...
                                                        <input onclick="save()" type="button" value="Report" class="btn btn-secondary">
        ...
        <script src="Ajax/PatientJS.js" type="text/javascript"></script>
