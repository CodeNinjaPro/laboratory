            ...
            <div class="page-content d-flex align-items-stretch">
                ...
                <nav class="side-navbar">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="active"><a href="admin_view_payment.jsp"><i class="fa fa-money"></i>Payment</a></li>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-sm-3 form-control-label">Appointment ID</label>
                                                    <div class="col-sm-9">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input id="amount" type="text" onkeypress="validateNumber()"	value="1000" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-9">
