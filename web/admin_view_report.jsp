...
//            }
    ...
    <body onload="load()">
            ...
            <div class="page-content d-flex align-items-stretch">
                ...
                <nav class="side-navbar">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="active"><a href="admin_view_report.jsp"><i class="fa fa-bar-chart-o"></i>Report</a></li>
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal" id="form">
                                                <div class="form-group row">
                                                    <div class="col-sm-9">
                                                        <input id="report_id" type="hidden" value="0" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea id="description" name="w3review" rows="10" cols="1" class="form-control form-control-warning">
                                                        </textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
        ...
        <script src="Ajax/ReportJS.js" type="text/javascript"></script>
