            ...
            <div class="page-content d-flex align-items-stretch">
                ...
                <nav class="side-navbar">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="patient_view_payment.jsp"><i class="fa fa-money"></i>Payment</a></li>
                        <li class="active"><a href="patient_view_report.jsp"><i class="fa fa-bar-chart-o"></i>Report</a></li>
