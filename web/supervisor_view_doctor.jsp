            ...
            <div class="page-content d-flex align-items-stretch">
                ...
                <nav class="side-navbar">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="supervisor_view_appointment.jsp"><i class="fa fa-file-text-o"></i>Appointment</a></li>
                        ...
                        <li class="active"><a href="supervisor_view_doctor.jsp"><i class="fa fa-user-md"></i>Doctor</a></li></br>
